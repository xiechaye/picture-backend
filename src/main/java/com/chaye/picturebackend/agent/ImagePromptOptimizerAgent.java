...
public class ImagePromptOptimizerAgent extends ToolCallAgent {

    public ImagePromptOptimizerAgent(ChatModel dashscopeChatModel,
                                     @Qualifier("imagePromptOptimizerTools") ToolCallback[] tools) {
        // 调用父类构造函数
        super(tools, null);
        ...
        String nextStepPrompt = """
            ...
            - Remember: You are a prompt optimizer, NOT an image generator
            """;
